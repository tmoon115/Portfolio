...
public class LightController
{
    ...
    @FXML
    Rectangle car1, car2, car3, car4, car5, car6, car7, car8, car9, car10, car11, car12, car13, car14, car15, car16, EmergencyV;
    @FXML
    ...
    boolean EmerPresent = false;
    boolean EmerPresentW = false;
    boolean EmerPresentE = false;
    boolean EmerPresentN = false;
    boolean EmerPresentS = false;
    ...
    /*
        West Lane Car Spawns. Change the value of num to select amount of cars. -1 is the emergency vehicle
     */
    public void spawnRandW(){
        ...
        if(num == -1){
            EmergencyV.relocate(0,295);
            EmergencyV.setOpacity(1.0);
            EmerPresentW = true;
            EmerPresent = true;
            presentW = true;
        }
    ...
    /*
        East Lane Car Spawns. Change the value of num to select amount of cars. -1 is the emergency vehicle
     */
    ...
    /*
        North Lane Car Spawns. Change the value of num to select amount of cars. -1 is the emergency vehicle
     */
    ...
    /*
        South Lane Car Spawns. Change the value of num to select amount of cars. -1 is the emergency vehicle
     */
 ...
 /*
    The method that starts the simulation after the vehicles are created
  */
    @FXML
        ...
        if(active == false){
            ...
            if(CounterE>0) {
                ...
                for (int i = 0; i < CounterE; i++) {
                    ...
                    carTimeline[i].setCycleCount(Timeline.INDEFINITE);
                    carTimeline[i].setAutoReverse(false);
                    carTimeline[i].getKeyFrames().add(new KeyFrame(Duration.millis(11000),
    ...
    public void trackEmerCar(){
        if(EmerPresentE){
            if(EmergencyV.getTranslateX() < -550){
        ...
        if(EmerPresentN){
            if(EmergencyV.getTranslateY() > 300){
                EmerPres();
            }
        }
        if(EmerPresentS){
        ...
        TimerTask task = new TimerTask()
        {
            ...
            public void run()
            {
                if(start > delay)
                {
                    ...
                    carPresent();
                    carsGo();
                    if(EmerPresent==false) {
                        sensorAfterLight();
                        manipulateFlow();
                    }
                    if(EmerPresent == true){
                        trackEmerCar();
                        System.out.println("Tracking Emergency Vehicle");
                    }
                }
                else {
                    cancel();
    ...
    public void manipulateFlow()
    {
        ...
        if(((car14.getLayoutY() + car14.getTranslateY()) > ySS && (car14.getLayoutY() + car14.getTranslateY()) < (ySS + southSensor.getHeight())) && CounterS == 2)
        {
            noneS = true;
        }
        if(((car13.getLayoutY() + car13.getTranslateY()) > ySS && (car13.getLayoutY() + car13.getTranslateY()) < (ySS + southSensor.getHeight())) && CounterS == 1)
        {
            noneS = true;
        }
        else
        ...
        if((car2.getTranslateX() > xWS && car2.getTranslateX() < (xWS + westSensor.getWidth())) && CounterW == 2)
        {
            noneW = true;
        }
        if((car1.getTranslateX() > xWS && car1.getTranslateX() < (xWS + westSensor.getWidth())) && CounterW == 1)
        {
            noneW = true;
        }
        else
...
*/
        ...
        /*
        if(presentE == true && presentW == false && northGreen.getOpacity() == 1.0 && started == false)
        {
            case1();
            started = true;
        }
        else if(presentE == true && presentW == true && northGreen.getOpacity() == 1.0 && started == false)
        {
            case2();
            started = true;
        }
        if(presentE == false && presentW == true && northGreen.getOpacity() == 1.0 && started == false)
        {
            case1();
            started = true;
        }
        else if(presentN == true && presentS == false && westGreen.getOpacity() == 1.0 && started == false)
        {
            case1();
            started = true;
        }
        else if(presentN == true && presentS == true && westGreen.getOpacity() == 1.0 && started == false)
        {
            case2();
            started = true;
        }
        else if(presentN == false && presentS == true && westGreen.getOpacity() == 1.0 && started == false)
        {
            case1();
            started = true;
        }
